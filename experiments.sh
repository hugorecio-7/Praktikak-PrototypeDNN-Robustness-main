...
#sbatch sbatch_experiments.sh SENN_0_1 AutoAttack_adv
#sbatch sbatch_experiments.sh SENN_0_01 AutoAttack_adv
#sbatch sbatch_experiments.sh SENN_0_001 AutoAttack_adv
sbatch sbatch_experiments.sh Prob_PSENN AutoAttack_adv
